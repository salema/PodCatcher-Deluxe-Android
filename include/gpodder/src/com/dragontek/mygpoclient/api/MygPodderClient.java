...
public class MygPodderClient extends SimpleClient {
	 ...
	 * @param addUrls
	 *            a set of urls to be added to the device
	 * @param removeUrls
	 *            a set of urls to be removed from the device
	 ...
	 *            the id of the device to be updated
	 * @param since
	 *            should be a timestamp in seconds that has been retrieved
	 ...
	 * 
	 * @param actions
	 *            a {@link List} of {@link EpisodeAction} objects
