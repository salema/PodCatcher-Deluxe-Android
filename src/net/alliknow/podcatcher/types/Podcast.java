...
public class Podcast implements Comparable<Podcast> {
	...
	/**
	 * Create a new podcast from OPML outline string as
	 * generated by <code>toOpmlString</code> below.
	 * The constructor will try to work around a couple of
	 * corner-cases, but there are limits to this...
	 * @param opmlOutline The outline string.
	 */
	public Podcast(String opmlOutline) {
		if (opmlOutline != null) {
			this.name = opmlOutline.split("\"")[1];
			if (name == "null") name = null;
		
			try {
				this.url = new URL(opmlOutline.split("\"")[3]);
