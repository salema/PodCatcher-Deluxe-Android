...
public interface OnShowSuggestionsListener extends OnAddPodcastListener {
    ...
    /**
     * Get the podcast suggestions from cache. You can return <code>null</code>
     * and make suggestions be reloaded from the internets.
     * 
    ...
    /**
     * Writes the loaded podcast suggestions to a cache you might provide.
     * 
    ...
    /**
     * Get the list of currently already added podcast to be excluded from
     * suggestions.
     * 
